...
![Qualitative cross-system comparison on a crowded frame](../../assets/qualitative_panel.png)
...
![Risk-coverage: error vs coverage as low-confidence predictions are abstained](../../assets/risk_coverage.png)
